...
**SUPERSEDED** by [ADR-001](./001-emacs-packages.md) — current C# LSP is the Microsoft Roslyn Language Server (installed via `scripts/install-roslyn-lsp.sh`). OmniSharp remains available as a fallback.

Originally **IMPLEMENTED** 2026-02-09 — OmniSharp configured and used until Roslyn LSP became viable as a standalone server.
